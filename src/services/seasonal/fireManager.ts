...
function getFireVisual(intensity: number): string {
    // Déterminer quelle frame utiliser (on alterne entre 0 et 1)
    const frame = animationFrame % 2;

    if (intensity >= 85) {
        // Feu intense (Rugissant/Ardent) - 2 frames d'animation
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀🔥🔥🔥🔥🔥🔥
⠀⠀⠀⠀⠀⠀⠀🔥🔥🔥🔥🔥🔥🔥
...
⠀⠀⠀⠀╚═════════════════╝`;
        ...
        // Feu fort (Vif) - 2 frames d'animation
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀🔥🔥🔥🔥
...
⠀⠀⠀⠀╚═════════════════╝`;
        ...
        // Feu moyen (Stable) - 2 frames d'animation
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀🔥🔥🔥
...
⠀⠀⠀⠀╚═════════════════╝`;
        ...
        // Feu faible (Vacillant) - 2 frames d'animation pour effet de vacillement
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀🔥🔥
...
⠀⠀⠀⠀╚═════════════════╝`;
        ...
        // Feu très faible (Agonisant) - 2 frames pour effet de tremblement
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀🔥
...
⠀⠀⠀⠀╚═════════════════╝`;
        ...
        // Feu éteint - 2 frames d'animation pour effet de fumée qui se dissipe
        if (frame === 0) {
            return `⠀⠀⠀⠀╔═════════════════╗
⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀💨💨

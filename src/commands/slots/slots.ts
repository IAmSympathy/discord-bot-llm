        ...
        try {
            ...
            const animationEmbed = new EmbedBuilder()
                ...
                .setDescription(
                    ...
                    `[ <a:znSlots:1475710024813645874> | <a:znSlots:1475710024813645874> | <a:znSlots:1475710024813645874> ] 📍`
                )
                .setTimestamp();
            ...
            animationEmbed.setDescription(
                `<@${userId}> lance sa machine !\n\n` +
                `[ ${finalSymbols[0]} | <a:znSlots:1475710024813645874> | <a:znSlots:1475710024813645874> ] 📍`
            );
            ...
            animationEmbed.setDescription(
                `<@${userId}> lance sa machine !\n\n` +
                `[ ${finalSymbols[0]} | ${finalSymbols[1]} | <a:znSlots:1475710024813645874> ] 📍`
            );
            await interaction.editReply({embeds: [animationEmbed]});
